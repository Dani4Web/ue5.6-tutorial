...
void ATutorialCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ATutorialCharacter::Look);
...
void ATutorialCharacter::DoMove(float Right, float Forward)
{
...
void ATutorialCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ATutorialCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ATutorialCharacter::DoJumpEnd()
{
